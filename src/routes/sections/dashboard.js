...
const PatientListPage = lazy(() => import("src/pages/dashboard/patients/list"));
const PatientViewPage = lazy(() =>
  import("src/pages/dashboard/patients/view-patient")
);
...
const CompletedListPage = lazy(() =>
  import("src/pages/dashboard/appointment/completedList")
);
...
// PROVIDERS
const ProvidersCollectionPage = lazy(() =>
  import("src/pages/dashboard/providers/collection")
);
const ProvidersListPage = lazy(() =>
  import("src/pages/dashboard/providers/list")
);
const ProvidersProfilePage = lazy(() =>
  import("src/pages/dashboard/providers/providersProfile")
);
const ProvidersSpecialtyCardList = lazy(() =>
  import("src/pages/dashboard/providers/specialty")
);
// PRIMARY-CARE
const PrimaryCareListPage = lazy(() =>
  import("src/pages/dashboard/primary-care/list")
);
const PrimaryCareChatPage = lazy(() =>
  import("src/pages/dashboard/primary-care/chat")
);
const PrimaryCareProfilePage = lazy(() =>
  import("src/pages/dashboard/primary-care/general-profile")
);
const PrimaryCareMainPage = lazy(() =>
  import("src/pages/dashboard/primary-care/main-page")
);

// FACILITIES
const PharmaciesMap = lazy(() =>
  import("src/pages/dashboard/facilities/pharmacies")
);
const DiagnosticCentersMap = lazy(() =>
  import("src/pages/dashboard/facilities/diagnostic-centers")
);
const HospitalsMap = lazy(() =>
  import("src/pages/dashboard/facilities/hospitals")
);
// TOUR
...
const ViewCondition = lazy(() =>
  import("src/sections/mycare/conditions/viewCondition")
);
const ViewPreventiveCondition = lazy(() =>
  import("src/sections/mycare/preventive/viewCondition")
);
const ViewMedicationCondition = lazy(() =>
  import("src/sections/mycare/medication/viewCondition")
);
...
// HEALTH RECORDS
const VitalsPage = lazy(() => import("src/pages/dashboard/records/vitals"));
const OverviewHealthHistoryPage = lazy(() =>
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            path: "preventive-care/view-condition/:id",
            element: <ViewPreventiveCondition />,
          },
          {
            path: "medication/view-condition/:id",
            element: <ViewMedicationCondition />,
          },
          {
            path: "prescription/view-condition/:id",
            element: <ViewPrescriptionCondition />,
          },
        ],
      },
      {
      ...
      // },
      {
        ...
        children: [
          ...
          {
            path: "providers-collection",
            element: <ProvidersCollectionPage />,
          },
      ...
      },
      {
        ...
        children: [
          ...
          { path: "view/:id", element: <PatientViewPage /> },
        ],
      },
